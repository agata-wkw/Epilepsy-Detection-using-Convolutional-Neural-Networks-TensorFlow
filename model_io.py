...
def get_modle_id():
    model_id_filename = 'DeepParams' # Define it
...
def save_variables(sess, saver, epoch, model_id): 
    model_path = 'C:\\Users\\Aris\\Desktop\\Epilepsy\\logs\\model_variables\\Patient_'+model_id # Define it
...
def restore_variables(sess):
    ...
    model_path = 'C:\\Users\\Aris\\Desktop\\Epilepsy\\logs\\model_variables\\' # Define it
    print(model_path)   
